...
class _PrepareKtpScreenState extends State<PrepareKtpScreen> {
  ...
  Widget _buildLogo(double screenHeight) {
    return Padding(
      padding: EdgeInsets.only(top: screenHeight * 0.02), // ← diubah dari 8.0
      child: Align(
        alignment: Alignment.center,
        child: SizedBox(
          height: screenHeight * 0.07, // ← diubah dari 50.0
          child: Image.asset('assets/pensiunkuplus/pensiunku.png',
              fit: BoxFit.contain),
        ),
      ),
    );
  ...
  Widget _buildInstructionImage(double screenHeight) {
    return Padding(
      padding: EdgeInsets.only(
        top: screenHeight * 0.02,
        bottom: screenHeight * 0.008, // ← diubah dari 5.0
      ),
      child: Center(
        child: Column(
          ...
          children: [
            SizedBox(
              height: screenHeight * 0.18, // ← diubah dari 150.0
              child: Image.asset('assets/pensiunkuplus/uploadktp.png'),
            ),
  ...
  Future<void> _showDescriptionDialog(double screenHeight) {
    return showDialog(
      context: context,
        ...
        content: SingleChildScrollView(
          child: ListBody(
            children: [
              ...
              SizedBox(height: screenHeight * 0.005), // ← diubah dari 5
              const Text('\u2022 Posisikan KTP sesuai garis'),
              SizedBox(height: screenHeight * 0.005),
              const Text('\u2022 Pastikan KTP tidak blur'),
              SizedBox(height: screenHeight * 0.005),
              ElevatedButton(
                style: ElevatedButton.styleFrom(
                  backgroundColor: const Color(0xFF16826E),
                  padding:
                      EdgeInsets.all(screenHeight * 0.01), // ← diubah dari 10.0
    ...
    Navigator.of(context, rootNavigator: true)
        .pushNamed(
          ...
          arguments: CameraKtpScreenArgs(
            ...
            onPreviewImage: (pageCtx, ktpModel) =>
                _previewKtpImage(pageCtx, ktpModel as KtpModel),
          ),
        )
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        toolbarHeight: screenHeight * 0.2, // ← diubah dari 120.0
        ...
        children: [
          ...
          SafeArea(
            child: SingleChildScrollView(
              child: Padding(
                padding: EdgeInsets.symmetric(
                  vertical: screenHeight * 0.04, // ← diubah from 32.0
                  horizontal: screenHeight * 0.05, // ← diubah from 24.0
                ),
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.stretch,
                  children: [
                    _buildInstructionImage(screenHeight),
                    SizedBox(height: screenHeight * 0.02), // ← diubah from 15.0
                    Text(
                      ...
                      style: TextStyle(
                          fontSize: screenHeight * 0.018), // ← opsional
                    ),
                    SizedBox(height: screenHeight * 0.02), // ← diubah from 32.0
                    Center(
                      child: ElevatedButton(
                        style: ElevatedButton.styleFrom(
                          backgroundColor: const Color(0xFF16826E),
                          padding: EdgeInsets.symmetric(
                            vertical: screenHeight * 0.015, // ← diubah
                        ...
                        onPressed: () => _showDescriptionDialog(screenHeight),
                        child: Text(
                          'Ambil Foto',
                          style: TextStyle(
                              fontSize: screenHeight * 0.02), // ← opsional
                        ),
                      ),
                    ),
                    SizedBox(height: screenHeight * 0.1), // ← diubah from 80.0
                  ],
                ),
              ),
            ),
          ...
          if (_isLoadingOverlay)
            Center(
              child: Container(
                padding:
                    EdgeInsets.all(screenHeight * 0.025), // ← diubah from 20
                decoration: BoxDecoration(
                  color: Colors.white,
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: screenHeight * 0.02), // ← diubah from 16
                    const Text(
                      'Mohon tunggu...',
                      style: TextStyle(
