...
class _EWalletBankTujuanState extends State<EWalletBankTujuan> {
      ...
      body: Stack(
        children: [
          ...
          Positioned(
            ...
            left: horizontalPadding,
            right: horizontalPadding,
            child: _buildWalletCard(screenWidth, screenHeight, cardPadding),
          ),
  ...
  Widget _buildProfileGreeting(double screenWidth) {
    ...
    return Row(
      mainAxisAlignment:
          MainAxisAlignment.start, // Ubah ke start agar konsisten
      children: [
        CircleAvatar(
          radius: avatarRadius,
        ...
        children: [
          Padding(
            padding: EdgeInsets.only(
                left: horizontalPadding,
                bottom: screenWidth * 0.03), // Menggunakan horizontalPadding
            child: const Text(
              "Rekening Pencairan",
              style: TextStyle(
                fontSize: 18,
